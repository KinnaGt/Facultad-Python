...
while(len(caracter) != 1 & (not es_char) ):
    caracter = input('Ingrese solo un caracter y que sea una letra : ')
    es_char = caracter.isalpha()

arr_words = texto.split(' ')
print(f' Palabras que empiezan con {caracter} ')
for word in arr_words :
    if(word.startswith(caracter)):
        print(word)